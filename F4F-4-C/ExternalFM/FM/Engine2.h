...
public:
	...
	inline double getPropellerRPM();
	inline double getPropellerState();
...
{
	// Idle rpm + rpm
	return getRPMNorm() * 2700;
	//return 60.0 * m_hpOmega / (2.0 * PI);
}

double Engine2::getPropellerRPM()
{
	return getRPM() * 0.66;
}

double Engine2::getPropellerState()
{
	return m_propellerState;
}

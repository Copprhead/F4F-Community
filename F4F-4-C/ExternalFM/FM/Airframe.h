...
public:
	...
	inline void setFoldingWingPosition(double position);
	...
	inline double getFoldingWingPosition() const;
...
private:
	...
	double m_foldingWingPosition = 0.0;
...
void Airframe::setFoldingWingPosition(double position)
{
	m_foldingWingPosition = position;
}
...
double Airframe::getFoldingWingPosition() const
{
	return m_foldingWingPosition;
}
